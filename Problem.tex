...
Sætning 3.4 siger at der findes en $n \times n$ matrix $A$, der har n forskellige egenvektore. I det tilfælde findes der et $V = [v_1,v_2,...v_n]$, hvor ${v_j}$ kolonner bestående af egenvektore. Derudover er diagonalmatricen $D$ med egenværdierne i diagonalen. Dette kan samles som følgende:  $A=VDV^1$.

Nu kan vi så lade $L = \lim_{k \rightarrow \infty} A^t$, hvor vi bruger viden fra opgaven om at $B=VDV^1$ er diagonaliserbar. Vi ved, at $B^k = V D^k (V^{-1})^t = V D^k V^t$. Det kommer til at se ud som følgende:
...
Lad $L = \lim_{k \rightarrow \infty} A^t$, da alle kolonner i L skal være egenvektorer af At med egenværdi 1, og da kolonnerne i L er multipler af hinanden, kan man konkludere, at L er en Markovmatrix.
